 ...
 *
 * The wordmark is the leaf logo. Scope colors below stay the product
 * identity for charts and reports; they are no longer drawn inside the logo.
 */
...
export const BRAND_ASSETS = {
  ...
  symbol: "/brand/carboscan-logo-light.png",
