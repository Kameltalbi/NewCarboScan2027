-- Ajouter tous les facteurs d'impact manquants avec des noms uniques

-- Aluminium avec unité 't' 
INSERT INTO impact_factors (item, unit, category, climate_co2e, acidification_so2e, water_m3) VALUES
('Aluminum_metric_ton', 't', 'Materiaux', 8100, 85, 20);

-- Verre avec unité 't'
INSERT INTO impact_factors (item, unit, category, climate_co2e, acidification_so2e, water_m3) VALUES
('Glass_metric_ton', 't', 'Materiaux', 850, 12, 1.5);
