...
const PUBLIC_SITEMAP_ROUTES = [
  ...
  { path: "/engagement-fournisseurs", changefreq: "monthly", priority: 0.85 },
  ...
  { path: "/solutions/solutions", changefreq: "monthly", priority: 0.7 },
  { path: "/solutions/accompagnement", changefreq: "monthly", priority: 0.7 },
  ...
  { path: "/bilan-carbone-finance", changefreq: "monthly", priority: 0.8 },
  { path: "/bilan-carbone-services", changefreq: "monthly", priority: 0.8 },
