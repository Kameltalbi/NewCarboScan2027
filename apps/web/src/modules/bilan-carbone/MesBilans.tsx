...
import { useOrganizationIdCached } from "@/contexts/AppDataContext";
...
export const MesBilans: React.FC = () => {
  ...
  const { user } = useAuth();
  const { organizationId } = useOrganizationIdCached();
        ...
        {bilans.length === 0 ? (
          <Card className="text-center py-12">
            <CardContent>
              ...
              <Button onClick={() => navigate('/app/bilan-carbone/questionnaire')}>
                      ...
                      <div>
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <span className="text-sm text-gray-600">
                            {format(new Date(bilan.date_creation), 'dd MMMM yyyy', { locale: fr })}
                          </span>
                        </div>
