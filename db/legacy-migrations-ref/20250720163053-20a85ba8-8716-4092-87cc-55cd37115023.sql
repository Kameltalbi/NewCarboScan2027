...
CREATE INDEX idx_carbon_assessments_user_id ON public.carbon_assessments(user_id);
CREATE INDEX idx_contact_requests_user_id ON public.contact_requests(user_id);
CREATE INDEX idx_training_registrations_user_id ON public.training_registrations(user_id);
