...
import { Shield, FileText, Globe, Users, Target } from "lucide-react";

export const ACVLandingWhyCarboScanSection: React.FC = () => {
  const { t } = useTranslation();
  const points = t("acvLanding.whyCarboScan.points", { returnObjects: true });
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              {t("acvLanding.whyCarboScan.title")}
            </h2>
          </div>
